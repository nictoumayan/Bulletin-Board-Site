...
app.get("/post/:postID", function (req, res) {
  ...
  for(var i = 0; i < posts.length; i++) {  //change to a forEach loop?


    var postTitle = _.lowerCase(posts[i].title);
...
app.post("/compose", function(req,res){
  ...
  posts.unshift(composition); //using unshift instead of push to make it update more like a regular blog
  res.redirect("/");
